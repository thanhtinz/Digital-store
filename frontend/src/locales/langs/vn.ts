...
const vn = {
  ...
  auth: {
    password_min_8: `Mật khẩu tối thiểu 8 ký tự`,

    forgot_title: `Quên mật khẩu?`,
    forgot_desc: `Nhập email tài khoản, chúng tôi sẽ gửi liên kết đặt lại mật khẩu cho bạn.`,
    send_request: `Gửi yêu cầu`,
    return_signin: `Quay lại đăng nhập`,
    email_sent: `Nếu email tồn tại, chúng tôi đã gửi liên kết đặt lại mật khẩu. Vui lòng kiểm tra hộp thư (cả mục spam).`,
    ...
    register_title: `Đăng ký tài khoản miễn phí.`,
    ...
    or: `HOẶC`,
    agree_1: `Khi đăng ký, tôi đồng ý với`,
  ...
  orders_page: {
    gift_order: `Đơn quà tặng`,
    gift_recipient: `Người nhận`,
    gift_sent: `Đã gửi sản phẩm tới người nhận`,
    gift_pending: `Sẽ gửi tới người nhận sau khi giao hàng`,
  ...
  checkout_page: {
    gift_title: `Mua tặng bạn bè`,
    gift_desc: `Gửi sản phẩm tới email người nhận thay vì bạn`,
    gift_email_label: `Email người nhận quà`,
    gift_email_help: `Sản phẩm sẽ được gửi tự động tới email này`,
    gift_email_invalid: `Email người nhận không hợp lệ`,
    gift_message_label: `Lời nhắn (tuỳ chọn)`,
    gift_message_ph: `Gửi lời chúc tới người nhận...`,
  ...
  affiliate_page: {
    ...
    info_desc_1: `Chia sẻ link giới thiệu cho bạn bè. Khi họ mua hàng, bạn nhận`,
    info_desc_2: `hoa hồng trên mỗi đơn.`,
    redeem_title: `Quy đổi`,
    total_received: `Tổng tiền nhận được`,
    total_referrals: `Tổng số người giới thiệu`,
    people: `người`,
    remaining: `Số tiền còn lại`,
    redeem_btn: `Quy đổi`,
    tx_history: `Lịch sử giao dịch`,
    f_desc: `Mô tả`,
    f_amount_from: `Số tiền từ`,
    f_amount_to: `Số tiền đến`,
    f_from_date: `Từ ngày`,
    f_to_date: `Đến ngày`,
    f_reset: `Xoá lọc`,
    col_time: `Thời gian`,
    col_desc: `Mô tả`,
    col_amount: `Số tiền`,
    commission_for_order: `Hoa hồng đơn`,
    cancel: `Huỷ`,
