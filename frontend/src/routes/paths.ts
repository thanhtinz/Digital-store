...
export const PATH_DASHBOARD = {
  ...
  admin: {
    ...
    appearance: path(ROOTS_DASHBOARD, '/admin/appearance'),
    ...
    settingsSecurity: path(ROOTS_DASHBOARD, '/admin/settings/security'),
    ...
    banners: path(ROOTS_DASHBOARD, '/admin/banners'),
    flashSales: path(ROOTS_DASHBOARD, '/admin/flash-sales'),
    giftCodes: path(ROOTS_DASHBOARD, '/admin/gift-codes'),
    ...
    intPayment: path(ROOTS_DASHBOARD, '/admin/integrations/payment'),
    intMail: path(ROOTS_DASHBOARD, '/admin/integrations/mail'),
    intTelegram: path(ROOTS_DASHBOARD, '/admin/integrations/telegram'),
    intOauth: path(ROOTS_DASHBOARD, '/admin/integrations/oauth'),
    intProviders: path(ROOTS_DASHBOARD, '/admin/integrations/providers'),
    intAi: path(ROOTS_DASHBOARD, '/admin/integrations/ai'),
    badges: path(ROOTS_DASHBOARD, '/admin/badges'),
    ranks: path(ROOTS_DASHBOARD, '/admin/ranks'),
  ...
  ranks: path(ROOTS_DASHBOARD, '/ranks'),
