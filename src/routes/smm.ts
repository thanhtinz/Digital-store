  ...
  try {
    ...
    const item = await prisma.smmService.create({
      data: {
        ...
        dripFeed: b.drip_feed || false,
        avgTimeMinutes: b.avg_time_minutes || null,
  ...
  try {
    ...
    const item = await prisma.smmService.update({
      ...
      data: {
        ...
        ...(b.cost_rate !== undefined && { costRate: b.cost_rate }),
        ...(b.api_provider_id !== undefined && { apiProviderId: b.api_provider_id || null }),
        ...(b.external_service_id !== undefined && { externalServiceId: b.external_service_id || null }),
        ...(b.can_refill !== undefined && { canRefill: b.can_refill }),
        ...(b.can_cancel !== undefined && { canCancel: b.can_cancel }),
        ...(b.drip_feed !== undefined && { dripFeed: b.drip_feed }),
        ...(b.avg_time_minutes !== undefined && { avgTimeMinutes: b.avg_time_minutes || null }),
